...
import com.app.domain.mapper.MapStructMapper;
...
public class EmpleadoAdminController {
    ...
    public ResponseEntity<?> obtenerEmpleados() {
        ...
        if (empleados.isEmpty()) {
            ...
            mensaje.put("mensaje", "No existen empleados");
    ...
    public ResponseEntity<?> obtenerEmpleadoPorId(@PathVariable Long id) {
        ...
        if (oEmpleado.isEmpty()) {
            mensaje.put("estado", Boolean.FALSE);
            mensaje.put("mensaje", String.format("No existe empleado con el ID: %d", id));
            return ResponseEntity.badRequest().body(mensaje);
        }
    ...
    public ResponseEntity<?> eliminarEmpleado(@PathVariable Long id) {
        ...
        if (oEmpleado.isEmpty()) {
            mensaje.put("estado", Boolean.FALSE);
            mensaje.put("mensaje", String.format("No existen empleados con el ID: %d", id));
            return ResponseEntity.badRequest().body(mensaje);
        }
    ...
    public ResponseEntity<?> obtenerEmpleadosPorEstadoVacunacion(@PathVariable String estadoVacunacion) {
        ...
        if (empleados.isEmpty()) {
            mensaje.put("estado", Boolean.FALSE);
            mensaje.put("mensaje", String.format("No existen empleados %s", sEstadoVacunacion));
            return ResponseEntity.badRequest().body(mensaje);
        }
    ...
    public ResponseEntity<?> obtenerEmpleadosPorTipoVacuna(@PathVariable String tipoVacuna) {
        ...
        if (empleados.isEmpty()) {
            mensaje.put("estado", Boolean.FALSE);
            mensaje.put("mensaje", String.format("No existen empleados con la vacuna %s", sTipoVacuna));
            return ResponseEntity.badRequest().body(mensaje);
        }
    ...
    public ResponseEntity<?> obtenerEmpleadosPorRangoFechaVacunacion(@PathVariable String fechaInicio, @PathVariable String fechaFin) {
        ...
        if (empleados.isEmpty()) {
            mensaje.put("estado", Boolean.FALSE);
            mensaje.put("mensaje", "No existen empleados vacunados en el rango de fechas ingresadas");
            return ResponseEntity.badRequest().body(mensaje);
        }
